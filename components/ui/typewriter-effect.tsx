...
export const TypewriterEffectSmooth = ({
  ...
  const hasArabicText = words.some((word) => isArabicText(word.text))
  ...
  return (
    <div
      className={cn(
        "flex items-baseline my-6",
        hasArabicText ? "flex-row-reverse space-x-reverse space-x-1" : "space-x-1",
        className,
      )}
    >
      <motion.div
      ...
      >
        <div
          ...
          style={{
            whiteSpace: "nowrap",
            lineHeight: hasArabicText ? "1.6" : "normal",
            direction: hasArabicText ? "rtl" : "ltr",
            textAlign: hasArabicText ? "right" : "left",
          }}
        >
          {renderWords()}{" "}
        </div>
